...
dataset_root = '/media/gpuadmin/rcao/dataset/UOAIS-Sim'
dataset_save_root = '/media/gpuadmin/rcao/dataset/detection/uoais_sim_coco'
...
for data_split in ['train', 'val']:
    ...
    json_file = os.path.join(dataset_root, 'annotations', '{}.json'.format(data_split))
    ...
    for img_idx, (_, image) in enumerate(image_dict.items()):
        ...
        copyfile(img_path, os.path.join(img_save_root, '{}_{}_{}.png'.format(data_split, img_split, img_id)))
        create_custom_json(os.path.join(img_save_root, '{}_{}_{}.png'.format(data_split, img_split, img_id)), 
                           img_ann, os.path.join(label_save_root, '{}_{}_{}.json'.format(data_split, img_split, img_id)))

        scene_images, scene_annotations = create_coco_label_json(len(images), img_path, img_ann, 
                                                                 '{}_{}_{}.png'.format(data_split, img_split, img_id))
